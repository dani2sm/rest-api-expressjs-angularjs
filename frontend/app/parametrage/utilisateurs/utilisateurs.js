...
controllers.controller('utilisateursController', ['$rootScope', '$scope', '$location', 'userService', 'profilService', 'paginationSize', 'bootstrapModal', function ($rootScope, $scope, $location, userService, profilService, paginationSize, bootstrapModal) {
