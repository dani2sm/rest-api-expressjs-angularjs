...
controllers.controller('userCtrl', ['$rootScope', '$scope', '$location', 'userService', 'roleService', 'paginationSize', 'bootstrapModal', function ($rootScope, $scope, $location, userService, roleService, paginationSize, bootstrapModal) {
  ...
  $scope.findUsers = function () {
    $scope.search = true;
    userService.findAllBy($scope.searchUser.firstname, $scope.searchUser.lastname, $scope.searchUser.abv, $scope.searchUser.phone, $scope.searchUser.login, $scope.searchUser.role.userRoleId
        , function (data) {
          $scope.users = data;
          $scope.pageChanged();
  ...
  function getRole(roleId) {
    for (var index in $scope.roles) {
      if ($scope.roles[index].id == roleId) {
        return $scope.roles[index]
      }
    }
    return {}
  }
